...
Currently, this project utilizes the pygame lirary for visualization. Eventually, it will utilize matplotlib for plotting simulation results, and numpy for modeling the netwok as a Markov chain and solving for the car system's steady-state distribution (eigenvalues).
